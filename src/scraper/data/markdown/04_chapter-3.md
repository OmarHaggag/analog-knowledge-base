...
This version (06 Jun 2017 14:50) was *approved* by [Doug Mercer](https://ez.analog.com/members/dmercer).The [Previously approved version](/university/courses/electronics/text/chapter-3?rev=1479322042) (16 Nov 2016 18:47) is available.[![Diff](/lib/images/diff.png)](https://wiki.analog.com/university/courses/electronics/text/chapter-3?do=diff&rev2[0]=1479322042&rev2[1]=1496760552&difftype=sidebyside)

### Table of Contents



* [Chapter 3: Introduction and Chapter Objectives](#chapter_3introduction_and_chapter_objectives)
	+ [3.1 Departures from Ideal](#departures_from_ideal)
	+ [3.2 The Non-Ideal Op Amp- Static Errors Due to Finite Amplifier Gain](#the_non-ideal_op_amp-_static_errors_due_to_finite_amplifier_gain)
		- [3.2.1 Noise Gain (NG)](#noise_gain_ng)
		- [3.2.2 Gain Stability](#gain_stability)
		- [3.2.3 Loop gain](#loop_gain)
		- [3.2.4 Frequency Dependence of Loop Gain](#frequency_dependence_of_loop_gain)
		- [3.2.5 The Bode Plot: Asymptotic And Actual Responses](#the_bode_plotasymptotic_and_actual_responses)
		- [3.2.6 Gain-Bandwidth Product](#gain-bandwidth_product)
		- [3.2.7 Stability Criteria](#stability_criteria)
		- [3.2.8 Phase Margin](#phase_margin)
	+ [3.3 Op Amp Input Offset Voltage](#op_amp_input_offset_voltage)
		- [3.3.1 Definition Of Input Offset Voltage](#definition_of_input_offset_voltage)
		- [3.3.2 Input Offset Voltage Drift And Aging Effects](#input_offset_voltage_drift_and_aging_effects)
		- [3.3.3 Measuring Input Offset Voltage](#measuring_input_offset_voltage)
		- [3.3.4 Offset Voltage Adjustment Using "NULL" Pins](#offset_voltage_adjustment_using_null_pins)
		- [3.3.5 Offset Adjustment (External Methods)](#offset_adjustment_external_methods)
		- [3.3.6 Offset Voltage Trim Processes](#offset_voltage_trim_processes)
	+ [3.4 Op Amp Input Bias Current](#op_amp_input_bias_current)
		- [3.4.1 Definition Of Input Bias Current](#definition_of_input_bias_current)
		- [3.4.2 Input Offset Current](#input_offset_current)
		- [3.4.3 Internal Bias Current Cancellation Circuits](#internal_bias_current_cancellation_circuits)
		- [3.4.4 Canceling The Effects Of Bias Current (External to the Op Amp)](#canceling_the_effects_of_bias_current_external_to_the_op_amp)
		- [3.4.5 Measuring Input Offset And Input Bias Current](#measuring_input_offset_and_input_bias_current)
	+ [3.5 Op Amp Total Output Offset Voltage Calculations](#op_amp_total_output_offset_voltage_calculations)
		- [3.5.1 Calculating Total Output Offset Error Due To IB And VOS](#calculating_total_output_offset_error_due_to_ib_and_vos)
...
[![](/_media/university/courses/electronics/text/chptr3-f1.png?w=500&tok=6ac549)](/_detail/university/courses/electronics/text/chptr3-f1.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f1.png")
...
But in reality, op amps do have finite gain, and errors exist in practical circuits. The op amp gain stage of figure 3.1 will be used to illustrate how these errors impact performance. In this circuit the op amp is ideal except for the finite open-loop DC voltage gain, A, which is usually stated as AVOL.
...
[![](/_media/university/courses/electronics/text/chptr3-e1.png?w=150&tok=6713c9)](/_detail/university/courses/electronics/text/chptr3-e1.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e1.png")   

3.1
[![](/_media/university/courses/electronics/text/chptr3-e2.png?w=80&tok=57e927)](/_detail/university/courses/electronics/text/chptr3-e2.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e2.png")   
...
[![](/_media/university/courses/electronics/text/chptr3-e3.png?w=150&tok=e4ea23)](/_detail/university/courses/electronics/text/chptr3-e3.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e3.png") 3.3
...
[![](/_media/university/courses/electronics/text/chptr3-e4.png?w=200&tok=11aa24)](/_detail/university/courses/electronics/text/chptr3-e4.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e4.png") 3.4




Where GCL is the finite-gain stage's closed-loop gain and AVOL is the op amp open-loop voltage gain for loaded conditions. 




It is important to note that this expression is identical to the ideal gain expression of equation 3.2, with the addition of the bracketed multiplier on the right side. Note also that this right-most term becomes closer and closer to unity, as AVOL approaches infinity. Accordingly, it is referred to in some textbooks as the error multiplier term, when the expression is shown in this form. 
...
It is useful to note some assumptions associated with the rightmost error multiplier term of equation 3.4. For AVOLβ » 1, one assumption is:




[![](/_media/university/courses/electronics/text/chptr3-e5.png?w=200&tok=3d4fa2)](/_detail/university/courses/electronics/text/chptr3-e5.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e5.png") 3.5




This in turn leads to an estimation of the percentage error, β, due to finite gain AVOL:




[![](/_media/university/courses/electronics/text/chptr3-e6.png?w=150&tok=d3692c)](/_detail/university/courses/electronics/text/chptr3-e6.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e6.png") 3.6




Again this error goes to zero as AVOL goes to infinity.
...
The closed-loop gain error predicted by these equations is not in itself tremendously important, since the ratio ZF/ZG could always be adjusted to compensate for this error. But note however that closed-loop gain stability is a very important consideration in most applications. Closed-loop gain instability is produced primarily by variations in open-loop gain due to changes in supply voltage, temperature, loading, etc. 




[![](/_media/university/courses/electronics/text/chptr3-e7.png?w=200&tok=025825)](/_detail/university/courses/electronics/text/chptr3-e7.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e7.png") 3.7




From equation 3.7, any variation in open-loop gain (βAVOL) is reduced by the factor AVOL β, insofar as the effect on closed-loop gain. This improvement in closed-loop gain stability is one of the important benefits of negative feedback. 
...
The product AVOL β which appears in the above equations, is called loop gain, a well known term in feedback theory. The improvement in closed-loop performance due to negative feedback is, in nearly every case, proportional to loop gain. 
...
[![](/_media/university/courses/electronics/text/chptr3-e8.png?w=170&tok=075918)](/_detail/university/courses/electronics/text/chptr3-e8.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e8.png") 3.8
...
[![](/_media/university/courses/electronics/text/chptr3-e9.png?w=170&tok=870776)](/_detail/university/courses/electronics/text/chptr3-e9.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e9.png") 3.9




Consequently, in a given feedback circuit the loop gain, AVOLβ, is approximately the numeric ratio (or difference, in dB) of the amplifier open-loop gain to the circuit closed-loop gain. 
...
**ADALM1000 Lab Activity [Open Loop Gain](/university/courses/alm1k/alm-lab-olg "university:courses:alm1k:alm-lab-olg")**
...
[![](/_media/university/courses/electronics/text/chptr3-f2.png?w=570&tok=40b3d5)](/_detail/university/courses/electronics/text/chptr3-f2.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f2.png")
...
• The open-loop gain AVOL for the two op amps is noted by the two curves marked 1MHz and 10MHz, respectively. Note that each has a -3dB corner frequency associated with it, above which the open-loop gain falls at 6dB/octave. These corner frequencies are marked at 10Hz and 100Hz, respectively, for the two op amps. 
...
**ADALM1000 Lab Activity [Gain Bandwidth Product](/university/courses/alm1k/alm-lab-gbw "university:courses:alm1k:alm-lab-gbw")**
...
If you plot the open-loop gain and then the noise gain on a Bode plot as shown in figure 3.3, the point where they intersect will determine the maximum closed-loop bandwidth of the amplifier system. This is commonly referred to as the closed-loop frequency (FCL). Remember that the actual response at the intersection is actually 3 dB down from this value. At frequencies beyond one octave above and one octave below FCL, the difference between the asymptotic response and the real response will be less than 1 dB.
...
[![](/_media/university/courses/electronics/text/chptr3-f3.png?w=600&tok=d86f52)](/_detail/university/courses/electronics/text/chptr3-f3.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f3.png")
...
[![](/_media/university/courses/electronics/text/chptr3-f4.png?w=600&tok=cb8eab)](/_detail/university/courses/electronics/text/chptr3-f4.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f4.png")
...
[![](/_media/university/courses/electronics/text/chptr3-f5.png?w=600&tok=7b1763)](/_detail/university/courses/electronics/text/chptr3-f5.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f5.png")
...
[![](/_media/university/courses/electronics/text/chptr3-f6.png?w=500&tok=25169a)](/_detail/university/courses/electronics/text/chptr3-f6.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f6.png")
...
Ideally, if both inputs of an op amp are at exactly the same voltage, then the output should be at zero volts. In practice, a small differential voltage will need to be applied to the inputs to force the output to zero. This is known as the input offset voltage, VOS. Input offset voltage is modeled as a voltage source, VOS, in series with the inverting input terminal of the op amp as shown in figure 3.7.




[![](/_media/university/courses/electronics/text/chptr3-f7.png?w=500&tok=840064)](/_detail/university/courses/electronics/text/chptr3-f7.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f7.png")
...
Input offset voltage varies with temperature, and its temperature coefficient is known as TCVOS, or more commonly, drift. Offset drift is affected by offset adjustments to the op amp, but when the offset voltage of a bipolar input op amp has been minimized, the drift may be as low as 0.1 µV/°C (typical value for OP177F). More typical drift values for a range of general purpose precision op amps lie in the range 1-10 µV/°C. Most op amps have a specified value of TCVOS, but some, instead, have a second value of maximum VOS that is guaranteed over the operating temperature range. Such a specification is less useful, because there is no guarantee that TCVOS is constant or monotonic.
...
[![](/_media/university/courses/electronics/text/chptr3-f8.png?w=500&tok=19c525)](/_detail/university/courses/electronics/text/chptr3-f8.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f8.png")
...
An alternate VOS measurement method is shown in figure 3.9, and is suitable for cases of high and/or unequal bias currents (as in the case of current feedback op amps). In this measurement method, an instrumentation amplifier is connected to the op amp input terminals through isolation resistors, and provides the gain for the measurement. The offset voltage of the in-amp (measured with S closed) must then be subtracted from the final VOS measurement.




[![](/_media/university/courses/electronics/text/chptr3-f9.png?w=500&tok=069363)](/_detail/university/courses/electronics/text/chptr3-f9.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f9.png")
...
[![](/_media/university/courses/electronics/text/chptr3-f10.png?w=600&tok=ea3632)](/_detail/university/courses/electronics/text/chptr3-f10.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f10.png")
...
* Wiper connection may be to either +VS or -VS depending on the op amp.
* Values for R1 and R2 depend on op amp, consult manufacturer's data sheet.
...
With an inverting op amp configuration, injecting current into the inverting input is the simplest method, as shown in figure 3.11A. The disadvantage of this method is that there is some increase in noise gain possible, due to the parallel path of R3 and the potentiometer resistance. The resulting increase in noise gain may be reduced by making ±VR large enough so that the R3 value is much greater than R1IIR2. Note that if the power supplies are stable and noise-free, they can be used as ±VR otherwise separate regulated low noise (filtered) sources should be used.




Figure 3.11B shows how to implement offset trim by injecting a small offset voltage into the non-inverting input. This circuit is preferred over figure 3.11A, as it results in no noise gain increase (but it requires adding RP). If the op amp has matched input bias currents, then RP should equal R1II R2 (to minimize the added offset voltage). Otherwise, RP should be less than 50Ω. For higher values, it may be advisable to bypass RP at high frequencies.




[![](/_media/university/courses/electronics/text/chptr3-f11.png?w=500&tok=e2131c)](/_detail/university/courses/electronics/text/chptr3-f11.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f11.png")
...
The circuit shown in figure 3.12 can be used to inject a small offset voltage when using an op amp in the non-inverting mode. This circuit works well for small offsets, where R3can be made much greater than R1. Note that otherwise, the signal gain might be affected as the offset potentiometer is adjusted. The gain may be stabilized, however, if R3 is connected to a fixed low impedance reference voltage sources, ±VR.




[![](/_media/university/courses/electronics/text/chptr3-f12.png?w=500&tok=3806d2)](/_detail/university/courses/electronics/text/chptr3-f12.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f12.png")
...
[![](/_media/university/courses/electronics/text/chptr3-f13.png?w=500&tok=6f71de)](/_detail/university/courses/electronics/text/chptr3-f13.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f13.png")





 Figure 3.13: Analog Devices' DigiTrim™ Process for Trimming CMOS Op Amps 
...
Ideally, no current flows into the input terminals of an op amp. In practice, there are always two input bias currents, IB+ and IB- (see figure 3.14).




[![](/_media/university/courses/electronics/text/chptr3-f14.png?w=500&tok=aa62b5)](/_detail/university/courses/electronics/text/chptr3-f14.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f14.png")
...
The input offset current, IOS, is the difference between IB- and IB+, or IOS = IB+ - IB-. Note also that IOS is only meaningful where the two individual bias currents are fundamentally reasonably well-matched, to begin with. This is true for most voltage feedback (VFB) op amps. However, it would not for example be meaningful to speak of IOS for a current feedback (CFB amplifiers are covered in more detail in a later chapter) op amp, as the currents are radically un-matched.
...
[![](/_media/university/courses/electronics/text/chptr3-f15.png?w=500&tok=9b38fb)](/_detail/university/courses/electronics/text/chptr3-f15.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f15.png")
...
When the bias currents of an op amp are well matched (the case with simple bipolar input stage op amps, but not internally bias compensated ones, as noted previously), a bias compensation resistor, R3, (R3=R1 || R2) introduces a voltage drop in the non-inverting input to match and thus compensate the drop in the parallel combination of R1 and R2 in the inverting input. This minimizes additional offset voltage error, as in figure 3.16. Note that if R3 is more than 1kΩ or so, it should be bypassed with a capacitor to prevent noise pickup. Also note that this form of bias cancellation is useless where bias currents are not well-matched, and will, in fact, make matters worse.




[![](/_media/university/courses/electronics/text/chptr3-f16.png?w=500&tok=5ec433)](/_detail/university/courses/electronics/text/chptr3-f16.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f16.png")
...
Input bias current (or input offset voltage) may be measured using the test circuit of figure 3.17. To measure IB, a large resistance, RS, is inserted in series with the input under test, creating an apparent additional offset voltage equal to IB×RS. If the actual VOS has previously been measured and recorded, the change in apparent VOS due to the change in RS can be determined, and IB is then easily computed. This yields values for IB+ and IB- The rated value of IB is the average of the two currents, or IB = (IB+ + IB-)/2.




Typical useful RS values vary from 100kΩ for bipolar op amps to 1000MΩ for some FET input devices. 




[![](/_media/university/courses/electronics/text/chptr3-f17.png?w=550&tok=dc426d)](/_detail/university/courses/electronics/text/chptr3-f17.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f17.png")
...
[![](/_media/university/courses/electronics/text/chptr3-f18.png?w=600&tok=317287)](/_detail/university/courses/electronics/text/chptr3-f18.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f18.png")
...
[![](/_media/university/courses/electronics/text/chptr3-f19.png?w=550&tok=f186be)](/_detail/university/courses/electronics/text/chptr3-f19.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-f19.png")
...
The gain from node A to VOUT is the same as the noise gain:




[![](/_media/university/courses/electronics/text/chptr3-e10.png?w=140&tok=0bee08)](/_detail/university/courses/electronics/text/chptr3-e10.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e10.png")




The gain from node B to VOUT is:




[![](/_media/university/courses/electronics/text/chptr3-e11.png?w=120&tok=6e0e98)](/_detail/university/courses/electronics/text/chptr3-e11.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e11.png")




[![](/_media/university/courses/electronics/text/chptr3-e12.png?w=600&tok=ba750e)](/_detail/university/courses/electronics/text/chptr3-e12.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e12.png")
...
[![](/_media/university/courses/electronics/text/chptr3-e13.png?w=500&tok=f44e84)](/_detail/university/courses/electronics/text/chptr3-e13.png?id=university%3Acourses%3Aelectronics%3Atext%3Achapter-3 "university:courses:electronics:text:chptr3-e13.png")
...
![R_3=[(R_1 R_2)/(R_1+R_2 )]](/lib/plugins/mathpublish/img.php?img=e67dc7e4c34c28248de1646678b5eaea "R_3=[(R_1 R_2)/(R_1+R_2 )]")
...
**Return to [Previous Chapter](/university/courses/electronics/text/chapter-2 "university:courses:electronics:text:chapter-2")**




**Go to [Next Chapter](/university/courses/electronics/text/chapter-4 "university:courses:electronics:text:chapter-4")**
...
university/courses/electronics/text/chapter-3.txt · Last modified: 06 Jun 2017 14:49 by [Doug Mercer](https://ez.analog.com/members/dmercer)
